...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "menu.size": "Size",
        "menu.switch_pet": "Switch Pet",
        "menu.flip_horizontal": "Flip Horizontally",
        ...
        "state.poke": "Poke",
        "state.drag": "Drag",
        "state.drag_3s": "Drag 3s",
        "state.drag_5s": "Drag 5s",
        ...
        "dialog.meal_breakfast_message": "Breakfast message",
        "dialog.meal_lunch_message": "Lunch message",
        "dialog.meal_dinner_message": "Dinner message",
    ...
    "zh": {
        ...
        "menu.size": "切换大小",
        "menu.switch_pet": "切换宠物",
        "menu.flip_horizontal": "左右镜像翻转",
        ...
        "dialog.meal_breakfast_message": "早餐文案",
        "dialog.meal_lunch_message": "午餐文案",
        "dialog.meal_dinner_message": "晚餐文案",
