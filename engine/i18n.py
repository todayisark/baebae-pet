...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "menu.todo": "To-Do",
        "todo.title": "To-Do",
        "todo.login_desc": "Connect your Google Account to sync tasks.",
        "todo.login_btn": "Sign in with Google",
        "todo.waiting_auth": "Waiting for authorization…",
        "todo.tab_pending": "To-Do",
        "todo.tab_done": "Done",
        "todo.add_placeholder": "+ Add a task…",
        "todo.add_btn": "Add",
        "todo.edit": "Edit",
        "todo.delete": "Delete",
        "todo.empty": "Nothing here",
    ...
    "zh": {
        ...
        "menu.todo": "待办事项",
        "todo.title": "待办事项",
        "todo.login_desc": "连接 Google 账号来同步你的待办事项。",
        "todo.login_btn": "登录 Google 账号",
        "todo.waiting_auth": "等待授权中…",
        "todo.tab_pending": "待办",
        "todo.tab_done": "已完成",
